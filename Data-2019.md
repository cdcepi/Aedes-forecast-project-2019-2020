...
Data providers are indicated for each state. These data providers **_and_** the 2019 Epidemic Prediction Initiative Aedes Forecasting Challenge should be acknowledged when using these data.
...
bp[Download California data](https://predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_california.csv)
...
bp[Download Connecticut data](https://predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_connecticut.csv)
...
bp[Download Florida data](https://predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_florida.csv)
...
bp[Download New Jersey data](https://predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_new_jersey.csv)
...
bp[Download New York data](https://predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_new_york.csv)
...
bp[Download North Carolina data](https://predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_north_carolina.csv)
...
bp[Download Texas data](https://predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_texas.csv)
...
bp[Download Wisconsin data](https:////predict.cdc.gov/api/v1/attachments/aedes_challenge_2019/aedes_collections_wisconsin.csv)
